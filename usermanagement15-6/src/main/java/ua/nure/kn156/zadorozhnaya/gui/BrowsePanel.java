package ua.nure.kn156.zadorozhnaya.gui;
...
import ua.nure.kn156.zadorozhnaya.util.Messages;
...
public class BrowsePanel extends JPanel implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("add".equalsIgnoreCase(actionCommand)) { //$NON-NLS-1$
            ...
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Choose user to edit",
            ...
            int selectedRow = userTable.getSelectedRow();
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Choose user to delete",
            ...
            int selectedRow = userTable.getSelectedRow();
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Choose user, to see detailed\ninfo about him/her",
